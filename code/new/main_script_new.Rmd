...
for (v in core_names) {
  ...
  raupc <- as.matrix(raupcrick(data_assembly, nsimul = 20))
  assembly <- iCAMP::qpen(data_assembly, pd = asv_distance2, RC=raupc, rand=20, sig.bNTI = 2, sig.rc = 0.95, ab.weight=F, nworker = 4)
