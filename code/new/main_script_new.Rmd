...
group.colors <- c(Core = "#e76f51", 'Non-core' = "#0077b6", Rare = "#2b9348", All = "black")
...
g <- rda_samples %>% 
  ...
  geom_hline(yintercept = 0, linetype = "dotted", color = "grey") +
  geom_vline(xintercept = 0, linetype = "dotted", color = "grey") +
  geom_point(size = 4, alpha = 0.8, color = group.colors[core_names[i]]) +
  geom_segment(
    data = rda_var, 
    inherit.aes = FALSE, 
    alpha = 0.8,
...
rda_figs[[1]] + rda_figs[[2]] + plot_layout(ncol=2, nrow=1) & theme(legend.position='none')
cat('\n','\n')
```
