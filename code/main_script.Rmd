...
# microbes taxonomy
tax <- read_delim("../data/data_raw/data_microbiome/ASVs_all_merged_taxonomy.tsv") %>% 
  rename(asv_ID = ASV)
...
data_asv_tax2 <- data_asv_tax %>% 
  filter(!(asv_ID %in% tax_cyn$asv_ID))
#data_asv <- data_asv_tax2[1:8]
```
