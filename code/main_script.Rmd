...
data_asv <- read_csv("../data/data_processed/microbiome/data_asv_rra0.001_p0.1-0.3_th1000.csv")
...
seq_aligned <- readDNAStringSet("../data/data_raw/data_microbiome/ASV_filtered_new4.fa")
