...
accuracy <- nrow(test_set_predict %>% filter(predict==1)) / nrow(test_set_predict)

conf_matrix <- table(test_set_predict$y_proba_th, test_set_predict$y_true)
conf_matrix

precision <- diag(conf_matrix) / colSums(conf_matrix)

roc_obj <- roc(test_set_predict$y_true, test_set_predict$y_proba)
