...
source("modularity_analysis_functions.R")
...
print(modules_similarity_three_villages[[i]])
...
library(psych)
print(psych::pairs.panels(village_summary %>% filter(grid1!="village") %>%  select(-village,-grid1,-grid2), ellipses = F, lm = T))
```
