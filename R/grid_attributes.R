# script for analyze grid attributes
...
##### vegetation #######################################################################
# vegetation attributes of all sites = 3 villages X 7 grids
...
# excluding vegetation of the pitfall traps
grid_sum <- plot_sum %>% 
  filter(pitfall == "Grid") %>% 
...
# making new row names - village_grid
...
# small mammal community of all sites = 3 villages X 7 grids
...
##### grid elevation #######################################################################
# elevation = the average observed elevation of all rats sampled in the grid
